...
uint8_t broadcastAddress[] = {0xc4, 0x4f, 0x33, 0x75, 0xa1, 0x6d};
...
const int JSX_PIN = 39;
const int JSY_PIN = 34;
const int SWITCH_PIN = 35;
const int THRESHOLD = 1850;   // Adjust this number to avoid noise when idle
  ...
  if (pulseSensor.sawNewSample()) {
    ...
    */
    if (--samplesUntilReport == (byte) 0) {
      ...
      //Serial.println(myBPM + space + JSX + space + JSY + space + SWITCH);
    ...
    *******/
        ...
        SWITCH = !(analogRead(SWITCH_PIN));
        myData.BPM_data = myBPM;
      myData.X_data = JSX;
      myData.Y_data = JSY;
      myData.SWITCH_data = SWITCH;
